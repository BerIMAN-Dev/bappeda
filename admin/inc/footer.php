                                ...
                                <li>
                                    <div class="message-center">
                                        ...
                                        <a href="#" class="user-info" id='chat_user_1' data-user-id='1'>
                                            <span class="user-img">
                                                <img src="../assets/assets/images/users/1.jpg" alt="user" class="circle">
                                        ...
                                        <a href="#" class="user-info" id='chat_user_2' data-user-id='2'>
                                            <span class="user-img">
                                                <img src="../assets/assets/images/users/2.jpg" alt="user" class="circle">
                                        ...
                                        <a href="#" class="user-info" id='chat_user_3' data-user-id='3'>
                                            <span class="user-img">
                                                <img src="../assets/assets/images/users/3.jpg" alt="user" class="circle">
                                        ...
                                        <a href="#" class="user-info" id='chat_user_4' data-user-id='4'>
                                            <span class="user-img">
                                                <img src="../assets/assets/images/users/4.jpg" alt="user" class="circle">
                        ...
                        <div id="activity" class="col s12">
                            <div class="m-t-10 p-10">
                                ...
                                <div class="steamline">
                                    ...
                                    <div class="sl-item">
                                        <div class="sl-left"> <img class="circle" alt="user" src="../assets/assets/images/users/2.jpg"> </div>
                                        <div class="sl-right">
                                    ...
                                    <div class="sl-item">
                                        <div class="sl-left"> <img class="circle" alt="user" src="../assets/assets/images/users/1.jpg"> </div>
                                        <div class="sl-right">
                                    ...
                                    <div class="sl-item">
                                        <div class="sl-left"> <img class="circle" alt="user" src="../assets/assets/images/users/4.jpg"> </div>
                                        <div class="sl-right">
                                            <div class="font-medium">Go to the Doctor <span class="sl-date">5 minutes ago</span></div>
                                            <div class="desc">Contrary to popular belief</div>
                                        </div>
                                    ...
                                    <div class="sl-item">
                                        <div class="sl-left"> <img class="circle" alt="user" src="../assets/assets/images/users/6.jpg"> </div>
                                        <div class="sl-right">
                                            <div><a href="javascript:void(0)">Stephen</a> <span class="sl-date">5 minutes ago</span></div>
                                            <div class="desc">Approve meeting with tiger</div>
                                        </div>
    ...
    <script src="../assets/assets/libs/perfect-scrollbar/dist/js/perfect-scrollbar.jquery.min.js"></script>
    <!-- ============================================================== -->
    <!-- Apps -->
    <!-- ============================================================== -->
